...
def seed_users():
    ...
    marnie = User(
        username='marnie', email='marnie@aa.io', password='password', first_name='marnie', last_name='ann', profile_image_url="https://avatars.githubusercontent.com/u/73668892?v=4")
    bobbie = User(
