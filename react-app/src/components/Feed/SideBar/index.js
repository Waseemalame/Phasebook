...
const SideBar = () => {
  return (
    <div className='sidebar-container'>
        <div><img className='profile-icon' src="https://scontent-lax3-1.xx.fbcdn.net/v/t1.30497-1/143086968_2856368904622192_1959732218791162458_n.png?stp=cp0_dst-png_p60x60&_nc_cat=1&ccb=1-7&_nc_sid=7206a8&_nc_ohc=kfSdWSkKc8EAX_rxrhi&_nc_ht=scontent-lax3-1.xx&oh=00_AT-KWu2XuszBsIEBIWx2SaOfefmOKr1BSaqZIpgB_swV-w&oe=63217AF8" alt=""/>Waseem Alame</div>
